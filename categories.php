            ...
            function OpenEditModal(elem){
                ...
                $('#confirm-update-btn').unbind('click').on('click',function(){
                    if(validateform()){
                        ...
                        formData.append("method","update_category");
                ...
                $('#edit-modal').find('.modal-title').text('Edit Category');
                $("#edit-modal").modal("show");
            }

            function openAddModal(){
                Resetform();
                $('#edit-modal').find('.modal-title').text('Add New Category');
                ...
                $('#confirm-update-btn').unbind('click').on('click',function(){
                    if (validateform()){
                        ...
                        formData.append("method","new_category");
                        formData.append("name",$('#name-input').val());
                        formData.append("active",($('#active-input').is(":checked") ? "1" : "0"));
                        formData.append("restaurant_id",restaurant_id);
                        $.ajax({
