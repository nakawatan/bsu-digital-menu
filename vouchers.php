...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <?php
                                        foreach($obj_list as $row) {
                                            ...
                                            $used = "<i class='fas fa-solid fa-check' style='color:#004d03'></i>";
                                            if ($row['active'] != "0") {
                                                $used = "<i style='color:#841306;font-weight: bold;'>x</i>";
                                            }
                                            echo "
        ...
        <div class="modal" id="delete-modal" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered">
                ...
                <div class="modal-body">
                    <p>Are you sure to delete Voucher?</p>
                </div>
        ...
        <div class="modal" id="edit-modal" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="logo-input" class="form-label">File:</label>
                        <input class="form-control" type="file" id="logo-input">
                    </div>
                    <div class="mb-3">
            ...
            <div class="modal-dialog modal-confirm">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        <h4>Success!</h4>	
                        <p>Voucher has been deleted successfully.</p>
        ...
        <div id="success-update-modal" class="modal fade" data-bs-backdrop="static">
            <div class="modal-dialog modal-confirm">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        <h4>Success!</h4>	
                        <p>Voucher has been updated successfully.</p>
        ...
        <script>
            ...
            //             if ($('#logo-input')[0].files.length > 0) {
            //                 myFile = $('#logo-input')[0].files[0];
            //                 formData.append("logo",myFile);
            //             }
            //             formData.append("method","update_merchant");
            ...
            //     $('#edit-modal').find('.modal-title').text('Edit Merchant');
            //     $("#edit-modal").modal("show");
            // }

            // function openAddModal(){
            //     Resetform();
            //     $('#edit-modal').find('.modal-title').text('Add New Merchant');
            ...
            //                 formData.append("logo",myFile);
            //             }
            //             formData.append("method","new_merchant");
            //             formData.append("name",$('#name-input').val());
            //             formData.append("active",($('#active-input').is(":checked") ? "1" : "0"));
            //             $.ajax({
            //                 url: '/api/',
